const favouritesList = document.getElementById("favourites-list"); // Get element for favorites meals in the list
const mealCardsWrapper = document.getElementById("meal-cards-wrapper"); // Get element for meal cards in the list
...
// function to delete data from favourites array using id 
